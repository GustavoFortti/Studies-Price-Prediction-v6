...
def main(args):
    config = Config(currency=args.currency, question=int(args.question), model_type=int(args.type_model), time_ahead=int(args.time_ahead)).config
...
if __name__ == '__main__':
    ...
    parser.add_argument("-tah" ,"--time_ahead", required=False)
